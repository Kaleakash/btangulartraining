...
getEmployeeInfo():Observable<Employee[]>{
  ...
  xdescribe('Employee Service - Mock Object ', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        providers:[{provide: EmployeeServiceFake, 
          useClass: EmployeeServiceFake}]
      }).compileComponents();
    }));
  
    //Service Testing   - Mock Service Method 
  
    it('Employee service post method - Mock Method', 
    inject([EmployeeServiceFake], 
